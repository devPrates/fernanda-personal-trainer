import { Trophy, Dumbbell, User2, Smartphone, User, Users } from 'lucide-react'
    ...
    <section className="min-h-screen py-20 px-4 flex items-center">
      <div className="max-w-7xl mx-auto w-full">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold mb-4">Conheça meus Serviços</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="p-6 text-center rounded-2xl border-2 border-purple-200 bg-white">
            ...
            <h3 className="text-xl font-semibold mb-3">Consultoria Online </h3>
            <p className="text-gray-600">
          ...
          <div className="p-6 text-center">
            ...
            <h3 className="text-xl font-semibold mb-3">Aplicativo de Treino</h3>
            <p className="text-gray-600">
